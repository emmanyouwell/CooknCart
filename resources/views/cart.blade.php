                ...
                <div class="card-body">
                    ...
                    @foreach ($cart as $item)
                        <div class="row product_data">
                            ...
                            <div class="col-md-3">
                                @if ($item->ingredient && $item->quantity >= $item->ingredient_quantity)
                                    <label for="quantity">Quantity</label>
                                    <div class="input-group text-center mb-3" style="width:130px;">
                                        <button class="input-group-text changeQuantity decrement-btn" type="button">-</button>
                                        <input type="number" name="quantity" class="form-control qty-input text-center"
                                            value="{{ $item->ingredient_quantity }}" min="1">
