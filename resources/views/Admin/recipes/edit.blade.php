                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                            rows="5">{{ old('description', $recipe->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('preptime') is-invalid @enderror" id="preptime"
                            name="preptime" value="{{ old('preptime', $recipe->preptime) }}"></input>
                        @error('preptime')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('cooktime') is-invalid @enderror" id="cooktime"
                            name="cooktime" value="{{ old('cooktime', $recipe->cooktime) }}"></input>
                        @error('cooktime')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('servings') is-invalid @enderror" id="servings"
                            name="servings" value="{{ old('servings', $recipe->servings) }}"></input>
                        @error('servings')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            @foreach ($ins as $instruction)
                                <tr>
                                    ...
                                    <td><input type="text" placeholder="Enter instruction"
                                            ...
                                            name="instruction[{{ $i }}][step]"
                                            value="{{ $instruction['step'] }}"></input>
                                    </td>
                                    <td><button type="button"
                                            class="btn btn-outline-danger remove-input-field">Delete</button></td>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('tags') is-invalid @enderror" id="tags" name="tags[]"
                            ...
                            @foreach ($ingredients as $tag => $ingredient)
                                <option value="{{ $tag }}"
                                    {{ in_array($tag, old('tags', json_decode($recipe->tags, true) ?: [])) ? 'selected' : '' }}>
                                    {{ $ingredient }}</option>
                            @endforeach
                        </select>
                        @error('tags')
