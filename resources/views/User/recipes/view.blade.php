                ...
                <div class="card post-card">
                    ...
                    <div class="post-content">
                        ...
                        @if ($recipe->ratings->count() > 0)
                            ...
                            ?>
                            <p>{{ number_format($averageRating, 1) }} <i class="fa-solid fa-star" style="color: #fff700;"></i></p>
                        @else
                            <p>No ratings yet</p>
                        @endif
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button class="btn btn-primary" type="button">Comment <i class="fa-solid fa-comment"></i></button>
                    </div>
                    <hr>
                    <div class="comments">
                        <div class="comment-item">
                            <div class="comment-content">
                                <span class="user-name">
                                    <img src="https://scontent.fmnl33-1.fna.fbcdn.net/v/t39.30808-1/366181326_103255029539724_136952219169775613_n.jpg?stp=dst-jpg_p240x240&_nc_cat=101&cb=99be929b-3346023f&ccb=1-7&_nc_sid=2b6aad&_nc_eui2=AeG_eABj3_Gk9av8MNbk-bNn_Scoq1-II879JyirX4gjzlh2DiqgjUjDdNyMLgIsPUYQqdklcTA2som7q4-abeg7&_nc_ohc=2_xIkz5rsv0AX_hKv7C&_nc_pt=1&_nc_ht=scontent.fmnl33-1.fna&oh=00_AfB6f4Dqia6BadyUgOiU_HSqKirtoIhI_JoQO24etxD3JQ&oe=64DC1DA8"
                                        width="40" class="user-avatar rounded-circle">
                                    {{ $recipe->user->name }} <i class="fa-solid fa-star" style="color: #ffea00;"></i><i
                                        class="fa-regular fa-star" style="color: #ffea00;"></i><i class="fa-regular fa-star"
                                        style="color: #ffea00;"></i><i class="fa-regular fa-star"
                                        style="color: #ffea00;"></i><i class="fa-regular fa-star"
                                        style="color: #ffea00;"></i><i class="fa-solid fa-regular"
                                        style="color: #ffea00;"></i><br>
                                </span>
                                <p class="comment-text">Di masarap.<br>
                                    <hr>
                                </p>
                            </div>
                        </div>
